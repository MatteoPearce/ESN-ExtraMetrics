NOTE: I did not need or use all these libraries. if any library related errors are thrown when running my scripts on your machine, check this list 
      in case you are using an outdated or too new a version. 

WARNING: Reservoirpy won't work with python >= 3.11



python version: 3.9.12

# packages in environment at C:\Users\matteo\anaconda3:
#
...
auto-py-to-exe            2.39.0                   pypi_0    pypi
automat                   20.2.0                     py_0
...
reservoirpy               0.3.9.post1              pypi_0    pypi
